...
import { Menu, Instagram, Facebook, Mail, Phone, MapPin, Sparkles } from "lucide-react"
            ...
            <div className="container mx-auto px-4 md:px-6 flex h-16 items-center justify-between">
                <div className="flex items-center gap-2">
                    <Link href="/" className="flex items-center space-x-2">
                        <span className="font-serif text-4xl font-light tracking-tight">PRIKA</span>
                    </Link>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Sheet open={isOpen} onOpenChange={setIsOpen}>
                        ...
                        <SheetContent side="right" className="w-[320px] sm:w-[400px] p-0 border-l-0 bg-red-500">
                            <motion.div
                            ...
                            >
                                    ...
                                    {navLinks.map((link, index) => (
                                        <motion.div key={link.href} variants={itemVariants}>
                                            <Link
                                                ...
                                                className="group relative py-3 px-4 -mx-4 rounded-md text-lg font-medium transition-all duration-200 hover:bg-primary/5 hover:text-primary block"
                                            >
                                ...
                                <motion.div variants={itemVariants} className="px-6 py-6 space-y-4">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-start gap-3 text-sm">
                                            ...
                                            <span className="text-muted-foreground">hello@prika.com</span>
                                        </div>
                                        <div className="flex items-start gap-3 text-sm">
                                ...
                                <motion.div variants={itemVariants} className="mt-auto px-6 py-6 bg-muted/30">
                                    <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
                                        Exquisite bespoke tailoring crafted for the modern elegance.
                                    </p>
